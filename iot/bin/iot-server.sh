...
do
    ...
    -Diot.analytics.host="172.28.128.6" \
    -Diot.analytics.https.port="9445" \
    -Diot.manager.host="172.28.128.5" \
    -Diot.manager.https.port="9443" \
    -Dmqtt.broker.host="172.28.128.4" \
    -Dmqtt.broker.port="1886" \
    -Diot.core.host="172.28.128.5" \
    -Diot.core.https.port="9443" \
    -Diot.keymanager.host="172.28.128.5" \
    -Diot.keymanager.https.port="9443" \
    -Diot.gateway.host="172.28.128.5" \
    ...
    -Diot.apimpublisher.host="172.28.128.5" \
    -Diot.apimpublisher.https.port="9443" \
    -Diot.apimstore.host="172.28.128.5" \
